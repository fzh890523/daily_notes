...
2. PS1/PROMPT乱码问题
> 没解决，估计是theme里给prompt用了特殊字符的原因，在windows下不支持。 最后换了theme（prompt内容），见 `git@bitbucket.org:fzh890523/yonka_personal.git 的 commit c39ef11bcc84db974c2728fb200f3164d0f228e6`
3. 默认shell设置
