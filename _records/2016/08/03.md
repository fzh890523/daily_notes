...
2. `aptitude remove libopencv-dev && aptitude remove aptitude remove libopencv-core-dev:amd64 && aptitude remove libopencv-core2.4:amd64`
3. `aptitude install libilmbase-dev && apt-get install openexr`
