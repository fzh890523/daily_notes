...
b.returnValue_}if(!1 in d)if(g=d[!1],g.remaining_=g.count_,c)for(h=0;!b.propagationStopped_&&h<f.length&&g.remaining_;h++)b.currentTarget=f[h],e&=goog.events.fireListeners_(g,f[h],b.type,!1,b)&&0!=b.returnValue_;else for(d=a;!b.propagationStopped_&&d&&g.remaining_;d=d.getParentEventTarget())b.currentTarget=d,e&=goog.events.fireListeners_(g,d,b.type,!1,b)&&0!=b.returnValue_;return!!e};goog.events.protectBrowserEventEntryPoint=function(a){goog.events.handleBrowserEvent_=a.protectEntryPoint(goog.events.handleBrowserEvent_)};
...
fyre.sp.i18n.prototype._setDefaults=function(){this._translations={automaticallyFollowConversations:"Automatically follow conversations I join",back:"Back",bio:"Bio",create:"Create",createANewAccount:"Create New Account",createNewAccountWithEmail:"Create a new account with email",changeAvatar:"Change Avatar",chooseFile:"Choose File",completeAccount:"Complete account",emailWhenSomeoneLikes:"Email when someone likes my comment",emailWhenSomeoneReplies:"Email when someone replies to me",emailCommentsIFollow:"Email comments in conversations I follow",
emailSenttoResetPassword:"Email sent! Check your inbox for a link to reset your password",emailVerificationSent:"Email Verification Sent",firstName:"First name",forgotPassword:"Forgot password?",forgotYourPassword:"Forgot your Password?",forgotYourPasswordInstructions:"Enter your username or email address below, and we'll send you a link to change your password.",formInputCloseButtonText:"Close",formInputCancelButtonText:"Cancel",formInputSaveButtonText:"Save",hasNotLeftAnyComments:"hasn't left any comments",
locationIsFrom:"is from",labelAvatar:"Avatar",labelComments:"Comments",labelConfirmNewPassword:"Confirm New Password",labelConfirmPassword:"Confirm Password",labelEmail:"Email Address",labelLikes:"Likes",labelLoading:"Loading",labelNewPassword:"New Password",labelNotifications:"Notifications",labelPassword:"Password",labelProfile:"Profile",labelUsername:"Username",labelUsernameOrEmail:"Username or email",lastName:"Last name",livefyreAccount:"Livefyre Account",location:"Location",loadingProfile:"Loading Profile",
newPassword:"New Password",oldPassword:"Old Password",on:"on",or:"or",passwordLinkExpired:"The link you clicked to reset your password has expired. Reset your password again, and we'll send you a new link.",pleaseCheckEmailToComplete:"Please check your email to complete your registration.",posted:"Posted",poweredBy:"powered by",profileNotificationImmediate:"immediate",profileNotificationHourly:"hourly",profileNotificationNever:"never",recentComments:"Recent Comments",reset:"Reset",resetPassword:"Reset Password",
signIn:"Sign In",signInWith:"Sign In With",signInWithEmail:"Sign In With Email",signUp:"Sign Up",socialAccount:"Social Account",successPasswordChanged:"Success! Your password has been changed, and you are now logged in",termsAndConditions:"Terms &amp; Conditions",termsAndConditionsIntro:"By signing up, you accept the",termsOfUse:"Terms of Use",termsOfUseIntro:"By logging in, you agree to",thisUser:"This user",verifyPassword:"Verify Password",fileSizeLimit:"2MB max",accountnotfound:"Account not found",
avatarImageExceedSize:"Your avatar image has exceeded the 2mb file limit",fieldisrequired:"Field is Required",fieldonlyacceptsaninteger:"Field only accepts an integer",fieldonlyacceptsavalidemail:"Field only accepts a valid email",fieldonlyacceptsletters:"Field only accepts letters",filesizemustbelessthanMB:"File size must be less than {#}MB",invalidusernameorpassword:"Invalid username or password",minimumlengthofcharacters:"Minimum length of {#} characters",maximumlengthofcharacters:"Maximum length of {#} characters",
therewasanerror:"There was an error",thisfieldisrequired:"This field is required.",validfileextensions:"Valid file extensions",valuemustmatch:"Value must match",passwordLength:"be 6 to 32 characters long.",passwordCharacters:"include both lower and upper case characters.",passwordSymbols:"include at least one number and one symbol.",passwordUsername:"not contain your username.",passwordPopoverTitle:"Your password needs to:",passwordErrorContainsFirstName:"The password you entered contains either your username, first name or last name. For security reasons, please enter a password that does not contain your username, first name or last name.<br><br>Please also remember that your password needs to contain:<br>6 to 32 characters<br>An uppercase character<br>A lowercase character<br>A symbol",
passwordErrorContainsLastName:"The password you entered contains either your username, first name or last name. For security reasons, please enter a password that does not contain your username, first name or last name.<br><br>Please also remember that your password needs to contain:<br>6 to 32 characters<br>An uppercase character<br>A lowercase character<br>A symbol",passwordErrorContainsUsername:"The password you entered contains either your username, first name or last name. For security reasons, please enter a password that does not contain your username, first name or last name.<br><br>Please also remember that your password needs to contain:<br>6 to 32 characters<br>An uppercase character<br>A lowercase character<br>A symbol",
passwordErrorTooShort:"Minimum of 6 characters for password",passwordErrorTooLong:"Maximum of 32 characters for password",passwordErrorMissingUppercase:"Password should contain at least one uppercase character",passwordErrorMissingLowercase:"Password should contain at least one lowercase character",passwordErrorMissingSymbol:"Password should contain at least one symbol in the set !@#$%^&*()?.,<>';:\"[]{}|"}};goog.userAgent.product={};goog.userAgent.product.ASSUME_FIREFOX=!1;goog.userAgent.product.ASSUME_CAMINO=!1;goog.userAgent.product.ASSUME_IPHONE=!1;goog.userAgent.product.ASSUME_IPAD=!1;goog.userAgent.product.ASSUME_ANDROID=!1;goog.userAgent.product.ASSUME_CHROME=!1;goog.userAgent.product.ASSUME_SAFARI=!1;
...
fyre.ui.Dialog.prototype.setContent=function(a){this.dialog.setContent(a);return this};fyre.ui.Dialog.prototype.setElement=function(a){this.removeElement();fyre.sp.config.lfep2&&(this.dialog.getTitleCloseElement().className+=" fyre-cp-modal-title-close-v2");fyre.dom(this.dialog.getContentElement()).append(a);return this};fyre.ui.Dialog.prototype.removeElement=function(a){goog.dom.removeChildren(this.dialog.getContentElement());return this};
fyre.ui.Dialog.prototype.open=function(){this.dialog.setVisible(!0);return this};fyre.ui.Dialog.prototype.close=function(a){this.dialog.setVisible(!1);!0===a&&this.dialog.removeChildren(!0);return this};
...
c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.localloginv2",{name:"include",hash:{},data:e}))+"\n"},12:function(a,b,c,d,e){var f,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'        <footer class="fyre-cp-tos">\n            '+k((g=null!=(g=c.termsOfUseIntro||(null!=b?b.termsOfUseIntro:b))?g:h,"function"===typeof g?g.call(d,{name:"termsOfUseIntro",hash:{},data:e}):g))+' <a target="_blank" href="'+k(a.lambda(null!=(f=null!=b?b.lfep2:b)?f.tosLink:f,b))+'">'+k((g=null!=(g=
c.termsOfUse||(null!=b?b.termsOfUse:b))?g:h,"function"===typeof g?g.call(d,{name:"termsOfUse",hash:{},data:e}):g))+"</a>\n        </footer>\n"},14:function(a,b,c,d,e){var f;d=null!=b?b:{};return'        <header class="fyre-cp-modal-header">\n            Sign in with\n            <img src="'+a.escapeExpression((c.media_url||b&&b.media_url||c.helperMissing).call(d,"images/default/logo.png",{name:"media_url",hash:{},data:e}))+'" align="right" alt="Livefyre" />\n        </header>\n        <section>\n'+
(null!=(f=c["if"].call(d,null!=b?b.socialAuth:b,{name:"if",hash:{},fn:a.program(15,e,0),inverse:a.noop,data:e}))?f:"")+(null!=(f=c["if"].call(d,null!=b?b.localAuth:b,{name:"if",hash:{},fn:a.program(17,e,0),inverse:a.noop,data:e}))?f:"")+"        </section>\n"},15:function(a,b,c,d,e){return"                "+a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.engage",{name:"include",hash:{},data:e}))+"\n"},17:function(a,b,c,d,e){return"                "+
a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.locallogin",{name:"include",hash:{},data:e}))+"\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,e){var f;d=null!=b?b:{};return(null!=(f=c["if"].call(d,null!=b?b.lfep2:b,{name:"if",hash:{},fn:a.program(1,e,0),inverse:a.program(3,e,0),data:e}))?f:"")+(null!=(f=c["if"].call(d,null!=b?b.lfep2:b,{name:"if",hash:{},fn:a.program(5,e,0),inverse:a.program(14,e,0),data:e}))?f:"")+"</div>"},useData:!0});
goog.exportSymbol("fyre.sp.templates.login",fyre.sp.templates.login);fyre.sp.templates.localloginv2="function"==typeof fyre.sp.templates.localloginv2?fyre.sp.templates.localloginv2:fyre.lib.Handlebars.template({1:function(a,b,c,d,e){return'        <footer class="fyre-cp-form-btns signin-view">\n'},3:function(a,b,c,d,e){return'        <footer class="fyre-cp-form-btns">\n'},5:function(a,b,c,d,e){var f;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'            <div class="fyre-cp-createnew fyre-cp-createnew-mobile">\n                <input class="fyre-cp-form-submit-btn mobile-signin-button" type="submit" value="'+
...
c.createANewAccount||(null!=b?b.createANewAccount:b))?f:g,"function"===typeof f?f.call(d,{name:"createANewAccount",hash:{},data:e}):f))+'">'+a((f=null!=(f=c.createANewAccount||(null!=b?b.createANewAccount:b))?f:g,"function"===typeof f?f.call(d,{name:"createANewAccount",hash:{},data:e}):f))+"</a>\n"},9:function(a,b,c,d,e){var f;return'            <input class="fyre-cp-form-submit-btn" type="submit" value="'+a.escapeExpression((f=null!=(f=c.signIn||(null!=b?b.signIn:b))?f:c.helperMissing,"function"===
typeof f?f.call(null!=b?b:{},{name:"signIn",hash:{},data:e}):f))+'" tabindex="3"/>\n'},11:function(a,b,c,d,e){var f;return null!=(f=c["if"].call(null!=b?b:{},null!=b?b.tosLink:b,{name:"if",hash:{},fn:a.program(12,e,0),inverse:a.noop,data:e}))?f:""},12:function(a,b,c,d,e){var f;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'                <footer class="fyre-cp-tos">\n                    '+a((f=null!=(f=c.termsOfUseIntro||(null!=b?b.termsOfUseIntro:b))?f:g,"function"===typeof f?
f.call(d,{name:"termsOfUseIntro",hash:{},data:e}):f))+' <a target="_blank" href="'+a((f=null!=(f=c.tosLink||(null!=b?b.tosLink:b))?f:g,"function"===typeof f?f.call(d,{name:"tosLink",hash:{},data:e}):f))+'">'+a((f=null!=(f=c.termsOfUse||(null!=b?b.termsOfUse:b))?f:g,"function"===typeof f?f.call(d,{name:"termsOfUse",hash:{},data:e}):f))+"</a>\n                </footer>\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,e){var f,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'<div class="fyre-cp-local-login">\n    <form class="fyre-cp-form">\n        <header class="fyre-cp-form-header">'+
k((g=null!=(g=c.signInWithEmail||(null!=b?b.signInWithEmail:b))?g:h,"function"===typeof g?g.call(d,{name:"signInWithEmail",hash:{},data:e}):g))+'</header>\n\t\t<fieldset>\n    \t    <label for="username">'+k((g=null!=(g=c.labelUsernameOrEmail||(null!=b?b.labelUsernameOrEmail:b))?g:h,"function"===typeof g?g.call(d,{name:"labelUsernameOrEmail",hash:{},data:e}):g))+'</label>\n\t        <input type="text" name="username" class="fyre-cp-input-username" data-fyre-validate="required" tabindex="1"/>\n\t\t</fieldset>\n\t\t<fieldset>\n    \t    <label for="password">'+
k((g=null!=(g=c.labelPassword||(null!=b?b.labelPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"labelPassword",hash:{},data:e}):g))+'</label>\n\t        <input type="password" name="password" class="fyre-cp-input-password" data-fyre-validate="required" tabindex="2"/>\n\t\t</fieldset>\n\n'+(null!=(f=c["if"].call(d,null!=b?b.is_mobile:b,{name:"if",hash:{},fn:a.program(1,e,0),inverse:a.program(3,e,0),data:e}))?f:"")+(null!=(f=c["if"].call(d,null!=b?b.is_mobile:b,{name:"if",hash:{},fn:a.program(5,
e,0),inverse:a.noop,data:e}))?f:"")+'            <div class="fyre-cp-form-btn-wrap">\n                <a href="'+k((g=null!=(g=c.forgotPwUrl||(null!=b?b.forgotPwUrl:b))?g:h,"function"===typeof g?g.call(d,{name:"forgotPwUrl",hash:{},data:e}):g))+'" class="fyre-cp-link-forgot" title="'+k((g=null!=(g=c.forgotPassword||(null!=b?b.forgotPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"forgotPassword",hash:{},data:e}):g))+'">'+k((g=null!=(g=c.forgotPassword||(null!=b?b.forgotPassword:b))?g:h,"function"===
typeof g?g.call(d,{name:"forgotPassword",hash:{},data:e}):g))+"</a>\n"+(null!=(f=c.unless.call(d,null!=b?b.is_mobile:b,{name:"unless",hash:{},fn:a.program(7,e,0),inverse:a.noop,data:e}))?f:"")+"            </div>\n"+(null!=(f=c.unless.call(d,null!=b?b.is_mobile:b,{name:"unless",hash:{},fn:a.program(9,e,0),inverse:a.noop,data:e}))?f:"")+"        </footer>\n"+(null!=(f=c["if"].call(d,null!=b?b.is_mobile:b,{name:"if",hash:{},fn:a.program(11,e,0),inverse:a.noop,data:e}))?f:"")+"    </form>\n</div>"},
...
fyre.sp.ui.Engage.prototype.registerControls=function(){fyre.sp.config.lfep2&&this.registerSocial();fyre.sp.config.auth.LOCAL&&(this.registerControl(this.getFormEl(),goog.events.EventType.SUBMIT,this.handleLoginSubmit),this.followLinks||this.registerLinks_(),this.isMobile&&this.registerNav_())};fyre.sp.ui.Engage.prototype.registerSocial=function(){var a=this.$el.getNByClass("social-login");this.registerControl(a,goog.events.EventType.CLICK,this.handleSocialLogin)};
...
d.ontimeout=function(){};d.onerror=function(){};var e=c.replace("http://","https://");"http:"===window.location.protocol&&(e=e.replace("https://","http://"));d.open("get",e+fyre.sp.config.JS_CONFIG+"/");d.send()}else(new fyre.io.Req({url:c+fyre.sp.config.JS_CONFIG+"/",success:function(a){b.configSuccess(b,a,c)},failure:function(a){}})).send();for(var f in a.events)this.messenger.subscribe(f,a.events[f])};
fyre.app.Base.prototype.configSuccess=function(a,b,c){b=b.data;fyre.sp.config.servers.profile=b.servers.profile;fyre.sp.config.servers.assets=b.assets;fyre.sp.config.CDN_HOST=b.default_cdn;fyre.sp.config.PUBLIC_API_URL=fyre.sp.config.servers.profile+fyre.sp.config.API_PATH;fyre.sp.config.customer_domain=c;c="v"+(fyre.sp.config.packageVersion||"0.0.0");var d="https://"+fyre.sp.config.CDN_HOST;fyre.sp.config.MEDIA_PATH=[d,"libs/identity",c,"simple"].join("/");fyre.sp.config.auth=function(a){a=a||"social";
return{SCHEMA:a,SOCIAL:goog.array.contains(["all","social"],a),LOCAL:goog.array.contains(["all","local"],a)}}(b.AUTH_SCHEMA);fyre.sp.config.social_networks=function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push({displayName:a[c].charAt(0).toUpperCase()+a[c].substr(1).toLowerCase(),service:a[c]});return{services:b}}(b.social_networks||[]);fyre.sp.config.tld=b.tld;fyre.sp.config.lfep2=b.lfep2||!1;fyre.sp.config.customerLogo=b.logo;fyre.sp.config.brand_color=b.brand_color||"#e86600";fyre.sp.config.tc=
b.tc;fyre.sp.config.font=b.font;fyre.sp.authController.loginByCookie(a.messenger);var e=fyre.util.browser.isMobile()?"mobile.css":"sp.css",e=[d,"libs/identity",c,"simple/css/default",e].join("/");fyre.sp.config.CDN_ASSET_PATH=[d,"libs/identity",c,"simple"].join("/")+"/";fyre.util.loadCSS(e);fyre.sp.i18n.getInstance().fetch(b.network,function(){a.ready()})};fyre.app.Base.prototype.ready=function(){};
...
(c=new fyre.io.XDR({url:f,success:b,failure:c}),goog.isString(a)&&(e={id:a}),c.send(e))};fyre.sp.client.ProfileClient.baseProfile_=function(a){return function(b,c,d){var e=new goog.net.IframeIo;goog.events.listen(e,goog.net.EventType.COMPLETE,function(a){a=a.target;var b=a.getResponseJson();a.isSuccess()?b.code&&413===parseInt(b.code,10)?d(b):c(b):d(b)});e.sendFromForm(b,fyre.sp.config.servers.profile+a)}};fyre.sp.client.ProfileClient.prototype.editProfile=fyre.sp.client.ProfileClient.baseProfile_("/api/v1.0/public/profile/edit/");
fyre.sp.client.ProfileClient.prototype.createProfile=fyre.sp.client.ProfileClient.baseProfile_("/api/v1.0/public/profile/create/");fyre.sp.client.ProfileClient.prototype.completeProfile=fyre.sp.client.ProfileClient.baseProfile_("/api/v1.0/public/profile/complete/");fyre.sp.client.ProfileClient.prototype.editPassword=function(a,b,c){(new fyre.io.XDR({url:fyre.sp.config.PUBLIC_API_URL+"/profile/edit/password/",method:"POST",success:b,failure:c})).send({password:a.password[0],token:a.token[0]})};fyre.sp.model={};fyre.sp.model.Profile=function(){this.model_={};this.ATTRIBUTES=fyre.sp.model.Profile.ATTRIBUTES;this.set(fyre.sp.model.Profile.DEFAULTS)};fyre.sp.model.Profile.prototype.set=function(a,b){goog.isDef(b)?this.model_[a]=b:goog.object.forEach(a,function(a,b){this.model_[b]=a},this)};fyre.sp.model.Profile.prototype.get=function(a){return goog.object.get(this.model_,a,null)};fyre.sp.model.Profile.prototype.toJSON=function(){return this.model_};
...
k((g=null!=(g=c.labelPassword||(null!=b?b.labelPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"labelPassword",hash:{},data:e}):g))+' *</label>\n                        <input type="password" name="password" id="fyrePassword" class="fyre-cp-input-password fyre-real-time" data-fyre-validate="required password-fyreDisplayName" />\n                    </fieldset>\n                </li>\n                <li>\n                    <fieldset>\n                        <label for="password_dup">'+k((g=
null!=(g=c.labelConfirmPassword||(null!=b?b.labelConfirmPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"labelConfirmPassword",hash:{},data:e}):g))+' *</label>\n                        <input type="password" name="password_dup" class="fyre-cp-input-password_dup" data-fyre-validate="required matches-'+k((g=null!=(g=c.labelPassword||(null!=b?b.labelPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"labelPassword",hash:{},data:e}):g))+'-fyrePassword" />\n                    </fieldset>\n                </li>\n                <li>\n                    <fieldset>\n                        <label for="email">'+
...
a((f=null!=(f=c.oldPassword||(null!=b?b.oldPassword:b))?f:g,"function"===typeof f?f.call(d,{name:"oldPassword",hash:{},data:e}):f))+' *</label>\n                            <input type="password" name="password_old" class="fyre-cp-input-password_old" data-fyre-validate="required"/>\n                        </fieldset>\n                    </li>\n                    <li>\n                        <fieldset>\n                            <label for="password">'+a((f=null!=(f=c.newPassword||(null!=b?b.newPassword:
b))?f:g,"function"===typeof f?f.call(d,{name:"newPassword",hash:{},data:e}):f))+' *</label>\n                            <input type="password" name="password" class="fyre-cp-input-password fyre-real-time" data-fyre-validate="required password-fyreDisplayName"/>\n                        </fieldset>\n                    </li>\n                    <li>\n                        <fieldset>\n                            <label for="password_verify">'+a((f=null!=(f=c.verifyPassword||(null!=b?b.verifyPassword:
b))?f:g,"function"===typeof f?f.call(d,{name:"verifyPassword",hash:{},data:e}):f))+' *</label>\n                            <input type="password" name="password_verify" class="fyre-cp-input-password_verify" data-fyre-validate="required"/>\n                        </fieldset>\n                    </li>\n                </ul>\n                <footer class="fyre-cp-edit-form-footer">\n                    <div class="fyre-cp-edit-close-wrapper fyre-cp-form-btns">\n                        <span class="fyre-cp-edit-save-msg"></span>\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="'+
...
k((g=null!=(g=c.bio||(null!=b?b.bio:b))?g:h,"function"===typeof g?g.call(d,{name:"bio",hash:{},data:e}):g))+'</label>\n                            <textarea name="aboutMe" class="fyre-input-aboutMe" fyre-validate="maxlength-500" maxlength="500">'+k((g=null!=(g=c.aboutMe||(null!=b?b.aboutMe:b))?g:h,"function"===typeof g?g.call(d,{name:"aboutMe",hash:{},data:e}):g))+'</textarea>\n                        </fieldset>\n                    </li>\n                </ul>\n                <footer class="fyre-cp-edit-form-footer">\n                    <div class="fyre-cp-edit-close-wrapper fyre-cp-form-btns">\n                        <span class="fyre-cp-edit-save-msg"></span>\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="'+
